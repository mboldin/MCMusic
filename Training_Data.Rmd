...
dim(Matrix_HB)
rowSums(Matrix_HB) # Check to make sure row sums are 1
...
dim(Matrix_YD)
rowSums(Matrix_YD) # Check to make sure row sums are 1
...
lengths = c(B1L,B2L,HBL,YDL,H1L,C1L,C2L,D1L,CMW1L,S1L,Spanish1L,Spanish2L,Spanish3L,Kuh1L,H1L)
Train = list(Matrix_Bach1,Matrix_Bach2,Matrix_HB,Matrix_YD,Matrix_Haydn1,
